...
export const CHANGELOG: PatchNote[] = [
  {
    ...
    title: 'Pets',
    items: [
      { type: 'new', text: 'Pets — roll a companion that buffs your XP while you work' },
      { type: 'new', text: 'Feed your pet with cooked food to restore hunger and level it up (10 levels)' },
      { type: 'new', text: 'Adventures — send your pet on timed expeditions for materials and gold' },
      { type: 'new', text: 'Scavenge ability (Lv3): find 1–3 common materials on a 24h cooldown' },
      { type: 'new', text: 'Motivation Burst ability (Lv6): activate +50% XP for 20 min (3-day cooldown)' },
      { type: 'new', text: 'Bond milestones: 7 days, 30 days, 50 feedings, 100 feedings, Lv10 — each unlocks a reward' },
      { type: 'new', text: 'Pet evolution: form changes at Lv10, shown in Bond Celebration modal' },
      { type: 'new', text: 'Desktop + in-app notifications for adventure complete and low hunger' },
      { type: 'new', text: 'Pet drops 1 material per session (5 min minimum, scales with level)' },
      { type: 'new', text: 'Hunger degrades over time — keep your pet fed or its buff fades' },
      { type: 'ui',  text: 'Pet tab in navigation with hunger/adventure-ready badge indicators' },
      { type: 'ui',  text: 'Mood-based ambient glow behind portrait (happy/playful/starving/sleeping)' },
      { type: 'ui',  text: 'Mood particles — animated effects matching emotional state' },
      { type: 'ui',  text: 'Companion voice lines under pet name' },
      { type: 'ui',  text: 'Bond milestone reward previews before unlock' },
      { type: 'ui',  text: 'Skill buff badge on skills widget showing active pet bonus (+X%)' },
      { type: 'ui',  text: 'Narrative flavor text in adventure loot modal' },
      { type: 'ui',  text: 'Feed modal empty state navigates to Cooking tab' },
    ],
  },
  {
    version: '4.7.0',
    date: '2026-03-31',
    title: 'macOS support, price charts & number formatting',
    items: [
      { type: 'new',     text: 'macOS support — Swift activity tracker, dock menu, DMG build' },
      { type: 'new',     text: 'Platform/OS tracking synced to Supabase' },
      { type: 'new',     text: 'Interactive price charts in Marketplace' },
      { type: 'new',     text: 'New item skins & item balance pass' },
      { type: 'ui',      text: 'Gold amounts now formatted with spaces (2 200, 1 000 000) in toasts, chest modals and quest rewards' },
      { type: 'fix',     text: 'DB: created_at backfill for profiles' },
      { type: 'fix',     text: 'DB: admin_retention_cohorts return type fixed' },
      { type: 'fix',     text: 'DB: session_histogram ORDER BY alias fix' },
    ],
  },
  {
    version: '4.6.0',
